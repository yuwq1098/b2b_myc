                        ...
                        <div class="m-section">
                            ...
                            <div class="m-con">
                                ...
                                <div class="info-line">
                                    ...
                                    <div class="data">（{{authText}}）支付车辆交易保证金</div>
                                </div>
                                <div class="info-line">
            ...
            goPay(){
                ...
                this.validator.validateAll({
                    ...
                    if(res){
                        ...
                        switch(this.auth){
                            case 'buyer':
                                data.amountType = "B2B买方保证金"
                                break;
                            case 'seller':
                                data.amountType = "B2B卖方保证金"
                                break;
                        }
                                ...
                                me.$confirm('正在进行支付操作，完成支付后请确认成功支付', '支付操作中', {
                                    ...
                                    cancelButtonText: '取消',
                                        ...
                                        setTimeout(()=>{
                                            ...
                                            }else if(me.auth=="seller"){
                                                me.$router.push({path:'/member/sellOrderDetails',query:{cid:me.orderId}})
                                            }
                                        },300)
                                    }).catch(() => {
