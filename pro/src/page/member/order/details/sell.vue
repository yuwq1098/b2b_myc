        ...
        computed:{
            statusText(){
                ...
                switch(this.orderData.status){
                    case 0:
                        return txt = "温馨提示：您的车辆已被秒杀，请您尽快向买方发起合同，若您逾期未发起，买方可能会申请仲裁进行维权！";
                        break;
                    case 1:
                        return txt = "温馨提示：发起合同成功！等待买方签署合同，若买方逾期未签署合同，您可以申请仲裁进行维权！";
                        break;
                    case 2:
                        return txt = "温馨提示：买方已签署合同！等待买方支付交易保证金，若买方逾期未支付，您可以申请仲裁进行维权！";
                        break;
                    case 3:
                        return txt = "温馨提示：请您支付交易保证金！支付前，若您主动取消订单，将扣除您的信誉保证金"+SYSTEM.MIN_CREDIT_GOLD+"元赔偿给买方；支付后，若您主动取消订单，将扣除您的交易保证金赔偿给买方，若交易成功，交易保证金退回";
                        break;
                    case 4:
                        return txt = "温馨提示：等待买方支付尾款，若线上交易，买方支付的尾款资金将由农业银行托管，交易完成后，尾款自动转入您的账户；线下交易请自行协商！";
                        break;
                    case 5:
                        return txt = "温馨提示：买方已支付尾款，请您尽快发货！若您逾期不出货，买方可能会申请仲裁进行维权";
                        break;
                    case 6:
                        return txt = "温馨提示：等待买方确认签收，若您如约发货并保证车辆与合同条款一致，买方却逾期不确认签收，您可以申请仲裁进行维权";
                        break;
                    case 7:
