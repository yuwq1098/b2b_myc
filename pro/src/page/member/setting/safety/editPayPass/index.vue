                                    ...
                                    <div class="u-tb-wrap">
                                        ...
                                        <div class="u-btn-box">
                                            ...
                                            <router-link class="u-lk"
                                                :to="{path:'/member/forgetPayPass'}">忘记密码？立即找回</router-link>
                                        </div>
                                    </div>
                                </div>
                                <div class="m-tb-con"
                                    ...
                                    <div class="u-tb-wrap v2">
                                        <div class="u-line-box input">
                                            <div class="line-error" v-if="errors.has('oldPayPass')">
                                                <p class="error-txt">
                                                    <i class="iconfont icon-jinggao1"></i>{{errors.first('oldPayPass')}}</p>
                                            </div><!-- 错误验证 -->
                                            <div class="line-inner">
                                                <div class="u-ipt-box">
                                                    <input class="u-ipt" 
                                                        v-model="oldPayPass" 
                                                        name="payPass"
                                                        auto-complete="off" type="password" placeholder="请输入旧支付密码" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="u-line-box input">
                                            <div class="line-error" v-if="errors.has('newPayPass')">
                                                <p class="error-txt">
                                                    <i class="iconfont icon-jinggao1"></i>{{errors.first('newPayPass')}}</p>
                                            </div><!-- 错误验证 -->
                                            <div class="line-inner">
                                                <div class="u-ipt-box">
                                                    <input class="u-ipt" 
                                                        v-model="newPayPass" 
                                                        name="newPayPass"
                                                        auto-complete="off" type="password" placeholder="请输入新支付密码" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="u-line-box input">
    ...
    export default {
        ...
        created(){
            this.validator = new Validator({
                oldPayPass: 'required|number|min:6|max:6',
                newPayPass: 'required|number|min:6|max:6',
                checkPayPass: 'required|confirmed:newPayPass',
        ...
        watch:{
            oldPayPass(val){
                this.validator.validate('oldPayPass',val);
            },
            newPayPass(val){
